...
private const val jobKey = "{{ cookiecutter.package_name }}.presentation.base.JOB_KEY"
private const val disposablesKey = "{{ cookiecutter.package_name }}.presentation.base.DISPOSABLES_KEY"
